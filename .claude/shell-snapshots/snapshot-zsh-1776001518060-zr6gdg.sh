...
if ! (unalias rg 2>/dev/null; command -v rg) >/dev/null 2>&1; then
  alias rg='/disk/hewenjing/.nvm/versions/node/v24.13.0/lib/node_modules/@anthropic-ai/claude-code/vendor/ripgrep/x64-linux/rg'
fi
export PATH=/disk/hewenjing/.bun/bin:/disk/hewenjing/.vscode-server/data/User/globalStorage/github.copilot-chat/debugCommand:/disk/hewenjing/.vscode-server/data/User/globalStorage/github.copilot-chat/copilotCli:/disk/hewenjing/.vscode-server/cli/servers/Stable-e7fb5e96c0730b9deb70b33781f98e2f35975036/server/bin/remote-cli:/disk/hewenjing/.bun/bin:/disk/hewenjing/.nvm/versions/node/v24.13.0/bin:/disk/hewenjing/miniconda3/bin:/disk/hewenjing/miniconda3/condabin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin
